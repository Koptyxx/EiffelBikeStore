...
public class HelloServiceLocator extends org.apache.axis.client.Service implements fr.uge.gustavebikeservice.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/GustaveBikeService/services/Hello";
    ...
    public fr.uge.gustavebikeservice.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.gustavebikeservice.HelloSoapBindingStub _stub = new fr.uge.gustavebikeservice.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.gustavebikeservice.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.gustavebikeservice.HelloSoapBindingStub _stub = new fr.uge.gustavebikeservice.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://gustavebikeservice.uge.fr", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://gustavebikeservice.uge.fr", "Hello"));
        }

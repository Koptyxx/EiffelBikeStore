...
public class HelloProxy implements fr.uge.gustavebikeservice.Hello {
  private String _endpoint = null;
  private fr.uge.gustavebikeservice.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new fr.uge.gustavebikeservice.HelloServiceLocator()).getHello();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public fr.uge.gustavebikeservice.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }

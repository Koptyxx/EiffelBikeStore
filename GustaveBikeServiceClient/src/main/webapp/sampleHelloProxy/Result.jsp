...
<jsp:useBean id="sampleHelloProxyid" scope="session" class="fr.uge.gustavebikeservice.HelloProxy" />
<%
...
case 10:
        gotMethod = true;
        fr.uge.gustavebikeservice.Hello getHello10mtemp = sampleHelloProxyid.getHello();

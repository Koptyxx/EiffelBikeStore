...
public class BanqueServiceLocator extends org.apache.axis.client.Service implements fr.uge.eiffelbikestore.banque.BanqueService {
    ...
    public fr.uge.eiffelbikestore.banque.Banque getBanque(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.eiffelbikestore.banque.BanqueSoapBindingStub _stub = new fr.uge.eiffelbikestore.banque.BanqueSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.eiffelbikestore.banque.Banque.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.eiffelbikestore.banque.BanqueSoapBindingStub _stub = new fr.uge.eiffelbikestore.banque.BanqueSoapBindingStub(new java.net.URL(Banque_address), this);
                _stub.setPortName(getBanqueWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://banque.eiffelbikestore.uge.fr", "BanqueService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://banque.eiffelbikestore.uge.fr", "Banque"));
        }

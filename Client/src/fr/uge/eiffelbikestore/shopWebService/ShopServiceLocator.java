...
public class ShopServiceLocator extends org.apache.axis.client.Service implements fr.uge.eiffelbikestore.shopWebService.ShopService {
    ...
    public fr.uge.eiffelbikestore.shopWebService.Shop getShop(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.eiffelbikestore.shopWebService.ShopSoapBindingStub _stub = new fr.uge.eiffelbikestore.shopWebService.ShopSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.eiffelbikestore.shopWebService.Shop.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.eiffelbikestore.shopWebService.ShopSoapBindingStub _stub = new fr.uge.eiffelbikestore.shopWebService.ShopSoapBindingStub(new java.net.URL(Shop_address), this);
                _stub.setPortName(getShopWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://shopWebService.eiffelbikestore.uge.fr", "ShopService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://shopWebService.eiffelbikestore.uge.fr", "Shop"));
        }
